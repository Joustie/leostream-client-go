...
type PoolProvision struct {
	Provision_on_off             int      `json:"provision_on_off"`
	Provision_tenant_id          int      `json:"provision_tenant_id"`
	Provision_threshold          int      `json:"provision_threshold"`
	Provision_vm_id              int      `json:"provision_vm_id"`
	Provision_vm_name            string     `json:"provision_vm_name"`
	Provision_vm_name_next_value int      `json:"provision_vm_name_next_value"`
	Provision_vm_display_name    string     `json:"provision_vm_display_name"`
	Provision_url                string     `json:"provision_url"`
	Provision_server_id          int      `json:"provision_server_id"`
	Provision_max                int      `json:"provision_max"`
	Provision_limits_enforce     int      `json:"provision_limits_enforce"`
